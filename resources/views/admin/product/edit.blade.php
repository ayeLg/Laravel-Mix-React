    ...
    <form action="{{ route('product.update', $p->slug) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-8">
                {{-- product info --}}
                <div class="card p-4">
                    <small class="text-mut">Product Info</small>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" id="description" cols="30" rows="10">{{ $p->description }}</textarea>
                    </div>
                </div>

                {{-- product pricing --}}
                <div class="card p-4">
                    <small class="text-mut">Product Pricing</small>
                    <div class="form-group">
